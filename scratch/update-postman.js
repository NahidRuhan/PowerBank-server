    ...
    item: [
      ...
      },
      {
        ...
        request: {
          ...
          url: {
            raw: '{{baseUrl}}/schedules/REPLACE_WITH_SCHEDULE_ID/status',
            host: ['{{baseUrl}}'],
            path: ['schedules', 'REPLACE_WITH_SCHEDULE_ID', 'status'],
          },
        },
      },
      {
        ...
        request: {
          ...
          header: [],
          url: {
            raw: '{{baseUrl}}/schedules/fairness',
            host: ['{{baseUrl}}'],
            path: ['schedules', 'fairness'],
          },
        },
      },
    ],
