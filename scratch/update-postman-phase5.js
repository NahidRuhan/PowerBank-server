      ...
      item: [
        ...
        },
        {
          ...
          request: {
            ...
            header: [],
            url: {
              raw: '{{baseUrl}}/payments/REPLACE_WITH_PAYMENT_ID/refund',
              host: ['{{baseUrl}}'],
              path: ['payments', 'REPLACE_WITH_PAYMENT_ID', 'refund'],
            },
          },
        },
      ],
